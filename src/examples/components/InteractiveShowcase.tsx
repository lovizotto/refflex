      ...
      <div className="w-full max-w-2xl flex flex-col h-full">
        <header className="mb-4">
          <h3 className="text-2xl font-bold text-gray-800">
            Vitrine Interativa da VirtualList
          </h3>
          <p className="text-sm text-gray-600">
            Esta lista renderiza virtualmente{" "}
            <strong className="text-blue-600 font-semibold">
              <S>{itemCount}</S>
            </strong>{" "}
            itens com alturas variáveis e alguns componentes "pesados".
          </p>
        </header>
        ...
        <footer className="text-center text-xs text-gray-500 pt-2">
          O navegador renderiza apenas os itens visíveis, evitando travamentos
