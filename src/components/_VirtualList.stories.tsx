    ...
    <div className="p-4 w-full h-screen flex flex-col items-center">
      <div className="w-full max-w-md">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Rendering 1,000 items with fixed estimated height. Only visible items
          are in the DOM.
        </p>
  ...
  return (
    <div className="p-4 w-full h-screen flex flex-col items-center">
      <div className="w-full max-w-md">
        ...
        <p className="text-sm text-gray-600 mb-4">
          Programmatically scroll to an item using an imperative handle ref.
        </p>
        <div className="mb-4 flex gap-2">
          ...
          <button
            ...
            className="p-2 px-4 bg-blue-500 text-white rounded-md font-semibold"
          >
            Go
          </button>
        </div>
  ...
  return (
    <div className="p-4 w-full h-screen flex flex-col items-center">
      <div className="w-full max-w-md">
        ...
        <p className="text-sm text-gray-600 mb-4">
          The list reactively updates when its underlying signal changes.
        </p>
        <div className="mb-4 flex flex-col gap-4">
          <div>
            <label className="block text-sm font-medium mb-1">
              Item Count: {useSignalValue(itemCount)}
            </label>
            <input
              type="range"
              min="100"
          ...
          <button
            ...
            className="p-2 px-4 bg-green-500 text-white rounded-md font-semibold"
          >
            Scroll to Random
          </button>
        </div>
